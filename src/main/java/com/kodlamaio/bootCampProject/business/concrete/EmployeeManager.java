...
public class EmployeeManager implements EmployeeService {
	...
	public DataResult<CreatEmployeeResponse> add(CreateEmployeeRequest createEmployeeRequest) {
		...
		CreatEmployeeResponse creatEmployeeResponse = this.modelMapperService.forResponse().map(employee,
				CreatEmployeeResponse.class);
	...
	public DataResult<List<GetAllEmployeeResponse>> getAll() {
		...
		for (Employee employee : employees) {
			GetAllEmployeeResponse listEmployeeResponse = this.modelMapperService.forResponse().map(employee,
	...
	private void checkIfEmployeeExistByNationalIdentity (String nationalIdentity) {
		Employee employee = this.employeeRepository.findEmployeeByNationalIdentity(nationalIdentity);
		if(employee!=null) {
	...
	private void checkIfEmployeeExistById (int id) {
		...
		if(employee==null) {
		throw new BusinessException(Messages.EmployeeUserNotfond);
	}
	}
